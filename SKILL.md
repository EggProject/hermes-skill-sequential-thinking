...
Enables structured problem-solving through iterative reasoning with revision and branching capabilities in Hermes Agent.
...
The Hermes MCP tool `mcp_sequential_thinking_sequentialthinking` accepts these parameters:
